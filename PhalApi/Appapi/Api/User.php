...
class Api_User extends PhalApi_Api {
	...
	public function getBaseInfo() {
		...
		if($agent_switch){
			$list1[]=array('id'=>'8','name'=>'邀请赚钱','thumb'=>get_upload_path("/static/appapi/images/personal/agent.png") ,'href'=>get_upload_path("/Appapi/Agent/index"));
		}
		if($shelves){
...
// 		}
        ...
        if($service_switch && $service_url){
           $list3[]=array('id'=>'21','name'=>'在线客服','thumb'=>get_upload_path("/static/appapi/images/personal/kefu.png") ,'href'=>$service_url); 
        }
