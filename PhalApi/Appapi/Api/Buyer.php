...
class Api_Buyer extends PhalApi_Api {
	...
	public function getRules() {
		return array(
			...
			'goodsOrderPay'=>array(
				...
				'type' => array('name' => 'type', 'type' => 'int',  'desc' => '支付类型 1 支付宝 2 微信 3 余额'),
				'time' => array('name' => 'time', 'type' => 'string', 'desc' => '时间戳'),
				'sign' => array('name' => 'sign', 'type' => 'string', 'desc' => '签名字符串'),
    ...
    public function goodsOrderPay(){
        ...
        if($uid<0||$token==""||$orderid<1||!in_array($type, ['1','2','3','4'])||$time<0||!$sign){
        	$rs['code']=1001;
        	$rs['msg']='参数错误';
        	return $rs;
        }
	...
	*/
    ...
    public function getGoodsOrderInfo(){
        ...
        if($order_info['status']==2||$order_info['status']==3||$order_info['status']==4){
            $express_info=getExpressStateInfo($order_info['express_code'],$order_info['express_number'],$order_info['express_name'],$order_info['username']);
